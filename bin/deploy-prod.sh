...
then
    echo "You need to create file config/secrets/prod/prod.decrypt.private.php from the contents at https://start.1password.com/open/i?a=&v=&i=ta7htureskqefhqz7x7h4a7ydq&h=my.1password.com"
    exit 1
fi
