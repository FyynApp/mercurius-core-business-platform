...
namespace App\BoundedContext\Membership\Application\Controller;

use App\BoundedContext\Account\Domain\Entity\User;
use App\BoundedContext\Membership\Application\Service\PaymentProcessorStripeService;
use App\BoundedContext\Membership\Domain\Entity\MembershipPlanName;
use App\BoundedContext\Membership\Domain\Entity\PaymentProcessor;
...
extends AbstractController
{
    ...
    {
        $subscription = $entityManager->find(\App\BoundedContext\Membership\Domain\Entity\Subscription::class, $subscriptionId);
