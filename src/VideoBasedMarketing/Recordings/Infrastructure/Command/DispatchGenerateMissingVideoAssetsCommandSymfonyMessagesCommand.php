...
#[AsCommand(
    name: 'app:videobasedmarketing:recordings:infrastructure:dispatch-generate-missing-video-assets-command-symfony-messages',
    description: '',
    aliases: ['dispatch-generate-missing-video-assets']
)]
class DispatchGenerateMissingVideoAssetsCommandSymfonyMessagesCommand
    extends Command
{
