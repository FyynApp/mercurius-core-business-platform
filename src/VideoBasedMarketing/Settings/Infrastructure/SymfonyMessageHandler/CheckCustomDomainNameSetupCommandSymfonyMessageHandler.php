...
namespace App\VideoBasedMarketing\Settings\Infrastructure\SymfonyMessageHandler;
...
use App\VideoBasedMarketing\Settings\Infrastructure\SymfonyMessage\CheckCustomDomainNameSetupCommandSymfonyMessage;
...
#[AsMessageHandler]
readonly class CheckCustomDomainNameSetupCommandSymfonyMessageHandler
{
    ...
    public function __invoke(
        CheckCustomDomainNameSetupCommandSymfonyMessage $message
    ): void
    {
        ...
        if (   is_array($cnameRecord)
            ...
            if ($checkResult !== 'This custom domain is working.') {
                ...
                $this->messageBus->dispatch(
                    new CheckCustomDomainNameSetupCommandSymfonyMessage($customDomainSetting)
                );
